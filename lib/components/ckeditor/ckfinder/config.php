...
//Set here Base Path
//define('SPATH_BASE', $editor_url.'ckfinder');
...
//$baseUrl =  '/iPhoneWS/IClubBar/hbpanel/lib/components/ckeditor/ckfinder/userfiles/';

//$baseUrl =  '/3rabShop/lib/components/ckeditor/ckfinder/userfiles/';
...
$baseUrl = "/iPhoneWS/IClubBar/hbpanel/lib/components/ckeditor/ckfinder/userfiles/";
$baseDir = resolveUrl($baseUrl);
//$baseUrl = "http://192.168.32.143/iPhoneWS/IClubBar/hbpanel/lib/components/ckeditor/ckfinder/userfiles/";
//$baseUrl = $site_url."lib/components/ckeditor/ckfinder/userfiles/";
$sitefolder = str_replace($_SERVER['DOCUMENT_ROOT'],"",dirname(dirname(__FILE__)))."/";
$site_url	= "http://".$_SERVER["HTTP_HOST"].$sitefolder;
$baseUrl = $site_url."ckfinder/userfiles/";
