...
* CLASS FILE:       /home/www/Occupy/hbpanel/lib/classes/phpClass/generated_classes/Country.Class.php5
...
class Country
{
	...
	function insert()
	{
		...
		$sql = "INSERT INTO country ( vCountryName,eStatus ) VALUES ( '".$this->_vCountryName."','".$this->_eStatus."' )";
	...
	function update($id)
	{
		...
		$sql = " UPDATE country SET  vCountryName = '".$this->_vCountryName."' , eStatus = '".$this->_eStatus."'  WHERE iCountryId = $id ";
		$result = $this->_obj->sql_query($sql);
