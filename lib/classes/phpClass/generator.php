...
<p>
	...
	*/
	...
	$id = "$" . "id";
	$thisdb = "$" . "this->" . "obj";
	$thisdbquery = "$" . "this->" . "_obj->execute($" . "sql" . ")";
	$result = "$" . "row = ";
	$row = "$" . "row";
	$result1 = "$" . "result";
	...
	*/
	...
	\tfunction select($id)
	\t{
	\t\t $sql \"CALL proc_$table ('SelectEdit', '$id' " . $strsel . ",'')\";
	\t\t $result $thisdbquery; \n
	";
	$sql = "SHOW COLUMNS FROM $table;";
	$database->query($sql);
	...
	$zeile1 = "$" . "sql" . " = \"CALL proc_$table ('Delete', '$id' " . $strsel . ",'')\"";
	$zeile2 = "$" . "result = $" . "this->_obj->execute($" . "sql);";
	$c.="
	...
	*/
	...
	$zeile1 = "$" . "this->$key = \"\"";
	$zeile2 = "CALL proc_$table ('Insert','',";
	$zeile5 = "'')";
	$zeile3 = "";
	$zeile4 = "";
	$zeile6 = "";
	...
	$sql = "$" . "sql =";
	$zeile7 = "$" . "result = $" . "this->_obj->execute($" . "sql);";
	$zeile8 = "$" . "row";
	$zeile9 = "$" . "result";
	$zeile10 = "";
	...
	*/
	...
	$zeile1 = "$" . "this->_$key = \"\"";
	$zeile2 = "CALL proc_$table ('Edit','\".$id.\"',";
	$zeile5 = ")";
	$zeile3 = "";
	$zeile4 = "";
	$zeile6 = "VALUES (";
