...
<div class="errorbox-position">
    ...
    ?> style="position: absolute; top: -18px; left: 270px;">
		<?php
		if (isset($_REQUEST['err_msg'])) {
...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" class="loginarea">
	<tr>
		<td colspan="3" class="login-headbg">Admin Login</td>
	</tr>
	<tr>
		<td class="loginbox-border">
			<table width="95%" border="0" cellpadding="1" cellspacing="1" rules=group align="center">
				<tr>
					<?php
					if (isset($_REQUEST['err_msg'])) {
                        echo "  <td height='10' class='errormsg' align='center'>" . $_REQUEST['err_msg'] . "</td>";
                    }
                    ?>
				</tr>
				<tr>
					<td>
						...
						<form name="form1" action="<?php echo $CFG->wwwroot; ?>/scripts/admin/login_a.php" method="post">
